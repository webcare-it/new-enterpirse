    ...
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <p class="text-muted mb-0">{{ translate('Update your landing page content') }}</p>
            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="name" id="name"
                                    placeholder="{{ translate('Page Name') }}" value="{{ $landingPage->name }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="title"
                                    placeholder="{{ translate('Page Title (H1)') }}" value="{{ $landingPage->title }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="sub_title"
                                    placeholder="{{ translate('Sub Title (H2)') }}" value="{{ $landingPage->sub_title }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" name="short_description" rows="3"
                                    placeholder="{{ translate('Brief description for the page') }}">{{ $landingPage->short_description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control aiz-text-editor" name="description"
                                    placeholder="{{ translate('Detailed description with HTML support') }}">{{ $landingPage->description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="banner_image" class="selected-files"
                                        value="{{ $landingPage->banner_image }}">
                                </div>
                                <div class="file-preview box sm">
                                    @if ($landingPage->banner_image)
                                        <img src="{{ uploaded_asset($landingPage->banner_image) }}" class="size-100px">
                                    @endif
                                </div>
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="mobile_banner" class="selected-files"
                                        value="{{ $landingPage->mobile_banner }}">
                                </div>
                                <div class="file-preview box sm">
                                    @if ($landingPage->mobile_banner)
                                        <img src="{{ uploaded_asset($landingPage->mobile_banner) }}" class="size-100px">
                                    @endif
                                </div>
                                <small
                                    ...
                                    <div class="product-row row mb-3">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" step="0.01" class="form-control"
                                                name="products[{{ $index }}][regular_price]"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="datetime-local" class="form-control" name="deadline"
                                    value="{{ $landingPage->deadline ? \Carbon\Carbon::parse($landingPage->deadline)->format('Y-m-d\TH:i') : '' }}">
                                <small
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="features-container">
                            @if ($landingPage->features && count($landingPage->features) > 0)
                            ...
                            @if ($landingPage->testimonials && count($landingPage->testimonials) > 0)
                                @foreach ($landingPage->testimonials as $index => $testimonial)
                                    <div class="testimonial-row row mb-3">
                                        ...
                                        <div class="col-md-3">
                                            <textarea class="form-control" name="testimonials[{{ $index }}][comment]" rows="2"
                                                placeholder="{{ translate('Testimonial Comment') }}">{{ $testimonial['comment'] ?? '' }}</textarea>
                                        </div>
                                        <div class="col-md-1">
                                            <button type="button"
                                                class="btn btn-sm btn-icon btn-danger remove-testimonial">
                                                <i class="las la-trash"></i>
                                            </button>
                                        </div>
                                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="faq-container">
                            @if ($landingPage->faq && count($landingPage->faq) > 0)
                                @foreach ($landingPage->faq as $index => $faqItem)
                                    <div class="faq-row row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <textarea class="form-control" name="faq[{{ $index }}][answer]" rows="2"
                                                placeholder="{{ translate('Answer') }}">{{ $faqItem['answer'] ?? '' }}</textarea>
                                        </div>
                                        <div class="col-md-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" name="meta_description" rows="3"
                                    placeholder="{{ translate('Meta Description for SEO') }}">{{ $landingPage->meta_description }}</textarea>
                                <small
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="meta_image" class="selected-files"
                                        value="{{ $landingPage->meta_image }}">
                                </div>
                                <div class="file-preview box sm">
                                    @if ($landingPage->meta_image)
                                        <img src="{{ uploaded_asset($landingPage->meta_image) }}" class="size-100px">
                                    @endif
                                </div>
                                <small
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="sold_count"
                                value="{{ $landingPage->sold_count }}" min="0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="visitor_count"
                                value="{{ $landingPage->visitor_count }}" min="0">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="copyright_text"
                                ...
                                value="{{ $landingPage->copyright_text }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="las la-save"></i> {{ translate('Update Landing Page') }}
                            </button>
                            <a href="{{ route('landingpages.index') }}" class="btn btn-secondary">
...
@section('script')
    <script type="text/javascript">
        let productIndex = {{ isset($selectedProducts) ? count($selectedProducts) : 1 }};
        let featureIndex = {{ isset($landingPage->features) ? count($landingPage->features) : 1 }};
        let testimonialIndex = {{ isset($landingPage->testimonials) ? count($landingPage->testimonials) : 1 }};
        let faqIndex = {{ isset($landingPage->faq) ? count($landingPage->faq) : 1 }};
