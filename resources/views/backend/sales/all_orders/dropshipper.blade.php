...
@section('content')
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">{{ translate('Dropshipper Order Management') }}</h1>
            </div>
    ...
    <div class="row mb-4">
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="mm-card mm-card-blue">
                ...
                <div class="mm-icon"><i class="las la-shopping-cart"></i></div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="mm-card mm-card-green">
                <div class="mm-content">
                    ...
                    <div class="stat-number" id="revenue-amount" data-hidden="true">৳ ******</div>
                    <div class="stat-small">{{ translate('Revenue generated') }}</div>
                </div>
                <div class="mm-icon"><i class="las la-chart-line"></i></div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="mm-card mm-card-orange">
                ...
                <div class="mm-icon"><i class="las la-clock"></i></div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="mm-card mm-card-purple">
                ...
                <div class="mm-icon"><i class="las la-check-circle"></i></div>
            </div>
        </div>
    </div>

    <!-- Filter Section (with Dropshipper dropdown) -->
    <div class="card mb-3">
        ...
        <div class="collapse {{ request()->has('search') || request()->has('delivery_status') || request()->has('payment_status') || request()->has('dropshipper_id') ? 'show' : '' }}"
            id="filterCollapse">
            <div class="card-body">
                <form method="GET" action="{{ route('orders.dropshippers') }}" id="filter-form">
                    <div class="row">
                        <!-- Search -->
                        <div class="col-md-3">
                        ...
                        <!-- 👇 NEW: Dropshipper Filter -->
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>{{ translate('Dropshipper') }}</label>
                                <select class="form-control" name="dropshipper_id">
                                    <option value="">{{ translate('All Dropshippers') }}</option>
                ...
                <table class="table table-bordered aiz-table">
                    <thead>
                        <tr>
                            ...
                            <th width="15%">{{ translate('Dropshipper') }}</th>
                    ...
                    <tbody>
                        @forelse($orders as $key => $order)
                            <tr>
                                ...
                                <td><strong>{{ $order->dropshipper->name ?? 'N/A' }}</strong></td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="{{ route('orders.download.invoice', $order->id) }}"
                                            title="Invoice Download" class="btn btn-sm btn-icon btn-secondary">
