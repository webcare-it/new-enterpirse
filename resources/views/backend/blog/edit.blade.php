                    ...
                    <div class="card-body">
                        <div class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" value="{{ $blog->blog_title }}"
                                        placeholder="{{ translate('Blog Title') }}" id="blog_title" name="blog_title"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="tags" name="tags" class="form-control"
                                        placeholder="Type and press enter..." value="{{ old('tags', $blog->tags ?? '') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="long_description">{{ $blog->long_description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="meta_title"
                                    placeholder="{{ translate('Meta Title') }}" value="{{ $blog->meta_title }}">
                            </div>
                        </div>
                        <div class="form-group row">
