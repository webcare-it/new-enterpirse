...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ uploaded_asset(get_setting('admin_site_icon')) }}">

    <title>{{ get_setting('admin_site_name') . ' | ' . get_setting('admin_site_motto') }}</title>
    ...
    <script>
        ...
        // Setup CSRF token for all AJAX requests to prevent logout
        $.ajaxSetup({
            headers: {
...
<body class="">
        ...
        <div class="aiz-content-wrapper">
            ...
            <div class="aiz-main-content">
                ...
                <div class="bg-white text-center py-3 px-15px px-lg-25px mt-auto">
                    <p class="mb-0">&copy; {{ get_setting('admin_site_name') }}
    ...
    <script>
        // CSRF token setup to prevent auto logout
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
