...
@section('content')
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-right">
                <a href="{{ route('reports.export-products', request()->query()) }}" class="btn btn-success">
    ...
    <div class="row mb-4">
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="mm-card mm-card-blue">
                <div class="mm-content">
                    ...
                    <div class="stat-small">{{ translate('All products') }}</div>
                </div>
                <div class="mm-icon">
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="mm-card mm-card-green">
                <div class="mm-content">
                    ...
                    <div class="stat-small">{{ translate('Available stock') }}</div>
                </div>
                <div class="mm-icon">
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <div class="mm-card mm-card-purple">
                <div class="mm-content">
                    <div class="stat-label">{{ translate('Average Price') }}</div>
                    <div class="stat-number">৳{{ number_format($avgPrice, 2) }}</div>
                    <div class="stat-small">{{ translate('Per product average') }}</div>
                </div>
                <div class="mm-icon">
    ...
    <div class="row mb-4">
        <div class="col-xl-4 col-md-6 mb-3">
            <div class="mm-card mm-card-green">
                <div class="mm-content">
                    <div class="stat-label">{{ translate('Published Products') }}</div>
                    <div class="stat-number">{{ number_format($publishedProducts) }}</div>
                    <div class="stat-small">{{ translate('Live products') }}</div>
                </div>
                <div class="mm-icon">
        ...
        <div class="col-xl-4 col-md-6 mb-3">
            <div class="mm-card mm-card-pink">
                <div class="mm-content">
                    <div class="stat-label">{{ translate('Draft Products') }}</div>
                    <div class="stat-number">{{ number_format($draftProducts) }}</div>
                    <div class="stat-small">{{ translate('Unpublished products') }}</div>
                </div>
                <div class="mm-icon">
        ...
        <div class="col-xl-4 col-md-6 mb-3">
            <div class="mm-card mm-card-dark">
                <div class="mm-content">
                    <div class="stat-label">{{ translate('Out of Stock') }}</div>
                    <div class="stat-number">{{ number_format($outOfStock) }}</div>
                    <div class="stat-small">{{ translate('Products unavailable') }}</div>
                </div>
                <div class="mm-icon">
    ...
    <div class="card mb-3">
        ...
        <div class="collapse {{ request()->has('search') || request()->has('category_id') || request()->has('brand_id') ? 'show' : '' }}"
            id="filterCollapse">
            <div class="card-body">
                <form method="GET" action="{{ route('reports.products') }}" id="filter-form">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="min_price"
                                    placeholder="{{ translate('Min Price') }}" value="{{ request('min_price') }}">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="max_price"
                                    placeholder="{{ translate('Max Price') }}" value="{{ request('max_price') }}">
                            </div>
                        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{ translate('Product Report') }}</h5>
                ...
                <table class="table table-bordered aiz-table">
                    <thead>
                        <tr>
                            ...
                            <th width="13%">{{ translate('Actions') }}</th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <td>
        <div class="btn-group" role="group">
            ...
            <a href="{{ route('products.edit', $product->id) }}" class="btn btn-sm btn-icon btn-primary"
