                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mt-2">
                                ...
                                <div class="font-weight-bold">
                                    {{ $totalReviews > 0 ? round(($approvedReviews / $totalReviews) * 100) : 0 }}%</div>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        @else
                                            <button type="button" class="btn btn-sm btn-icon btn-secondary"
                                                ...
                                                onclick="setReviewData({{ $review->id }}, 0)"
                                        ...
                                        <button type="button" class="btn btn-sm btn-icon btn-danger" data-toggle="modal"
                                            ...
                                            onclick="setDeleteForm('{{ route('reviews.destroy', $review->id) }}')"
                            ...
                            <tr>
                                <td colspan="8" class="text-center">
                                    <div class="py-5">
                                        ...
                                        <p class="text-muted">{{ translate('No reviews match your filter criteria.') }}
                                        </p>
                                        <a href="{{ route('reviews.index') }}" class="btn btn-primary"><i
                                                class="las la-undo-alt"></i> {{ translate('Clear Filters') }}</a>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
